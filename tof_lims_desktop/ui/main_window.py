...
class MainWindow(QMainWindow):
    def __init__(self, isotope_json: Path):
        ...
        self.setWindowTitle('TOF-LIMS Professional Spectrum Studio v2.1')
        self.resize(1600, 960)
        self._build_ui()

    def _build_ui(self):
        self.setStatusBar(QStatusBar())
        self.statusBar().showMessage('TOF-LIMS Desktop v2.1 ready')
    ...
    def render(self):
        try:
            ...
            QMessageBox.warning(self, 'Render Error', str(exc))
